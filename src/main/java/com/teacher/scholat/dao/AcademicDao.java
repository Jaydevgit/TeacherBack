...
public interface AcademicDao {
    ...
    List<JSONObject> getSearchTeacherProject(JSONObject jsonObject);
    ...
    List<JSONObject> getSearchTeacherPatent(JSONObject jsonObject);
    List<JSONObject> searchPatent(JSONObject jsonObject);

    List<JSONObject> getPublicationteacher(JSONObject jsonObject);
    List<JSONObject> getSearchPublication(JSONObject jsonObject);
    List<JSONObject> getSearchTeacherPublication(JSONObject jsonObject);
